...
#Preview {
    CityListView(
        viewModel: CityListViewModel(
            ...
            getCitiesUseCase: GetCitiesUseCase(dataRepo: DataRepository(realmService: RealmService())),
            storeCitiesUseCase: StoreCitiesUseCase(dataRepo: DataRepository(realmService: RealmService()))
        )
    )
}
